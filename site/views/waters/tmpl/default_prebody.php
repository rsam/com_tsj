	...
	?>
      	...
      	<table BORDER=0 COLS=2>
            ...
            ?>
      		...
      		<tr>
      			<td align=right>Показания счетчика №<?=$this->dataofsn->{'ser_num_cold_p'.$i}?> ХВС (холодной воды) :</td>
      			<td align=left><?php echo $this->form->getInput('cwater'.$i); ?><FONT
      				COLOR="#FF0000">*</FONT></td>
      		</tr>
      		<tr>
      			<td align=right>Показания счетчика №<?=$this->dataofsn->{'ser_num_hot_p'.$i}?> ГВС (горячей воды) :</td>
