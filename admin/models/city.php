 ...
 * TSJ Model
 */
class TSJModelCity extends JModelAdmin
{
	/**
	 ...
	 * @since	2.5
	 */
	public function getTable($type = 'City', $prefix = 'TSJTable', $config = array())
	{
	...
	{
		return 'administrator/components/com_tsj/models/forms/city.js';
	}
