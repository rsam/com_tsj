...
{
	class JToolbarButtonwImport extends JToolbarButton
	{
		// since   3.0
		var $_name = 'wImport';

		function fetchButton($type='wImport', $name = '', $text1 = '', $text2 = '', $task = 'wimport', $list = true, $hideMenu = false )
		{
...
*/
		 ...
		 * @ since   3.0
		 */
		public function fetchId($type = 'wImport', $name = '', $text = '', $task = '', $list = true, $hideMenu = false)
		{
	...
	class JButtonwImport extends JButton
	{
		/**
		 * Button type
		 *
		...
		function fetchButton($type='wImport', $name = '', $text = '', $task = 'wimport', $list = true, $hideMenu = false )
		{
