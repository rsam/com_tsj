 ...
 * TSJs View
 */
class TSJViewWaters extends JViewAbstract
{
	/**
	...
	protected function addToolBar()
	{
		...
		$bar->appendButton('Popup', 'options', 'COM_TSJ_BTN_MY_SETTINGS', 'index.php?option=com_tsj&amp;view=wconfig&amp;tmpl=component', 850, 400);
