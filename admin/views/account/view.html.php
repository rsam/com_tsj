 ...
 * TSJ View
 */
class TSJViewAccount extends JViewAbstract
{
	/**
	 * View form
	 *
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::cancel('account.cancel', $this->isNew ? 'JTOOLBAR_CANCEL' : 'JTOOLBAR_CLOSE');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($this->isNew ? JText::_('COM_TSJ_ACCOUNT_CREATING')
