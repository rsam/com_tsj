...
<form action="<?php echo JRoute::_('index.php?option=com_tsj&view=street'); ?>"
...
<?php endif;?>
		<table width=100% class="table table-striped adminlist" id="streetList">
			<thead>
	...
	<div>
        ...
        <input type="hidden" name="task" value="street" />
