...
<tr class="row<?php echo $i % 2; ?>">
	<td><?php echo $accountitem->account_id ; ?>
	</td>
	<td><?php echo JHtml::_('grid.id', $i, $accountitem->account_id); ?>
	</td>
	<td><a
		href="<?php echo JRoute::_('index.php?option=com_tsj&task=account.edit&layout=account&account_id='.(int) $accountitem->account_id); ?>">
	...
	<td><a
		href="<?php echo JRoute::_('index.php?option=com_tsj&task=account.edit&layout=edit&account_id='.(int) $accountitem->account_id); ?>">
	...
	if($accountitem->lic == '0'){
		?> <input type="checkbox" name="licf" disabled /> <?php
	} else {
		?> <input type="checkbox" name="licf" checked disabled /> <?php
	}
	?>
	</td>
</tr>
