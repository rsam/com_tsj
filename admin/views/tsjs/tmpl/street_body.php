...
<tr class="row<?php echo $i % 2; ?>">
	<td><?php echo $streetitem->street_id ; ?>
	</td>
	<td><?php echo JHtml::_('grid.id', $i, $streetitem->street_id); ?>
	</td>
	...
	<?php //endif; ?> <a
		href="<?php echo JRoute::_('index.php?option=com_tsj&task=street.edit&layout=street&street_id='.(int) $streetitem->street_id); ?>">
