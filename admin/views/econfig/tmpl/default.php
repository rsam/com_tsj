...
Joomla.submitbutton = function(task) {
	...
	//Joomla.submitbutton = function(task)
	//{
	//	if (task == 'econfig.cancel' || document.formvalidator.isValid(document.id('econfig-form'))) {
	//		Joomla.submitform(task, document.getElementById('econfig-form'));
	//	}
	//}
</script>
...
<form action="<?php echo JRoute::_('index.php?option=com_tsj'); ?>"
	method="post" name="adminForm" id="econfig-form" autocomplete="off"
	class="form-validate">
	...
	<fieldset>
		...
		<div class="fltrt">
			<button type="button"
				onclick="Joomla.submitform('econfig.save', this.form);window.top.setTimeout('window.parent.SqueezeBox.close()', 100);">
