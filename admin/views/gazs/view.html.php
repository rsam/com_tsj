 ...
 * TSJs View
 */
class TSJViewGazs extends JViewAbstract
{
	/**
	...
	{
		// Выводим заголовок
		JToolBarHelper::title(JText::_('COM_TSJ_MANAGER_GAZS'));

		$bar = JToolBar::getInstance('toolbar');
		$bar->appendButton('Popup', 'options', 'COM_TSJ_BTN_MY_SETTINGS', 'index.php?option=com_tsj&amp;view=gconfig&amp;tmpl=component', 850, 400);
