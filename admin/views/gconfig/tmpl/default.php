...
Joomla.submitbutton = function(task) {
	...
	//Joomla.submitbutton = function(task)
	//{
	//	if (task == 'gconfig.cancel' || document.formvalidator.isValid(document.id('gconfig-form'))) {
	//		Joomla.submitform(task, document.getElementById('gconfig-form'));
	//	}
	//}
</script>
...
<form action="<?php echo JRoute::_('index.php?option=com_tsj'); ?>"
	method="post" name="adminForm" id="gconfig-form" autocomplete="off"
	class="form-validate">
	...
	<fieldset>
		...
		<div class="fltrt">
			<button type="button"
				onclick="Joomla.submitform('gconfig.save', this.form);window.top.setTimeout('window.parent.SqueezeBox.close()', 100);">
